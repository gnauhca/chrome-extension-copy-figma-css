    ...
    <div class="setting-wrapper" v-if="refCurrent.enabled">
      ...
      <div class="form-item">
        ...
        <div class="control control--block" v-if="refCurrent.varEnabled">
          <div class="vars-edit">
            <Textarea placeholder="支持 sass less cssvar 例：@primary-color: #abc;" v-model:value="refCurrent.varStr"></Textarea>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  setup() {
    ...
    function scrollToCurrent() {
      ...
      setTimeout(() => {
        refTabWrapper.value.scrollTo({left: currentElem.offsetLeft, behavior: 'smooth'});
